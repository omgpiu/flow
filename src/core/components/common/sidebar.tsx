...
export const SideBar = memo(({addNode, generateNodes, serializeNodes}: Props) => {
    ...
    return (
        <aside>
            ...
            <div className="dndnode message" onDragStart={(event) => onDragStart(event, Nodes.WORK_FLOW)} draggable>
                {NODES_NAME[Nodes.WORK_FLOW]}
            </div>
            <div className="dndnode question" onDragStart={(event) => onDragStart(event, Nodes.PLACEHOLDER)}
                 draggable>
